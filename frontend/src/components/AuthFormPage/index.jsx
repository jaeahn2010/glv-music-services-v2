...
export default function AuthFormPage({ isMenuOpen, setLoginStatus, scrollToTop, userType, setUserType }) {
    ...
    return (
        <section className={`${isMenuOpen ? 'z-0 opacity-5' : ''} bg-stone-300 rounded-xl border border-stone-800 p-8 lg:w-1/3 mx-auto mt-24 mb-48 font-montserrat`}>
            ...
            <form className="w-full flex flex-col" onSubmit={handleSubmit}>
                ...
                <button
                    type="submit"
                    className="w-1/2 mx-auto border border-stone-800 my-5 rounded-xl duration-500 hover:bg-amber-300 py-1">
                    {btnText}
                </button>
                <p className="text-center pt-2 hover:text-stone-500 hover:cursor-pointer" onClick={() => {
                    scrollToTop()
