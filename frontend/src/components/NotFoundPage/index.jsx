...
export default function NotFoundPage() {
    return (
        <main className="h-[100vh] w-full flex flex-col justify-center items-center bg-stone-800">
            <h1 className="text-9xl font-extrabold text-stone-200 tracking-widest">
                404
            </h1>
