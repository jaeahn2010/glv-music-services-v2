...
export default function MusiciansCard({ musician, getFilteredMusiciansData, setMusicianDetails, loginStatus }) {
    ...
    return (
        <Link to={"/musician/details/" + musician._id} onClick={() => setMusicianDetails(musician)}>
            <figure className={`my-12 w-full mx-auto p-2 border border-stone-200 rounded-xl bg-gradient-to-r from-stone-800 via-stone-500 to-stone-800 font-poppins flex justify-center items-center`}>
                <div>
