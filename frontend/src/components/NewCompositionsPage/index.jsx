...
const ahnBentonAvailableCompositions = [
    ...
    [64.2, 'Romance No. 4', 'A Letter to You', [], 2010, 'piano', 6],
    ...
    ['96a', 'Theme and Varations No. 5', 'In the Garden', [], 2014, 'piano', 12],
    ['96b', 'Theme and Varations No. 5 (4 hands)', 'In the Garden', [], 2014, 'piano (4 hands)', 18],
    ['99a', 'Theme and Varations No. 6', 'Impressions of Ukraine', [], 2019, 'piano (4 hands)', 15],
    ['99b', 'Theme and Varations No. 6', 'Impressions of Ukraine', [], 2020, 'piano', 18],
]
        ...
        <main className={`${isMenuOpen ? 'z-0 opacity-5' : ''} relative font-poppins`}>
            ...
            ? <div className={`${showDetails ? 'z-50' : 'hidden'} absolute w-2/3 h-[50%] left-[16.67%] top-[10%] border border-stone-200 flex flex-col justify-center items-center bg-stone-700 rounded-3xl overflow-y-auto`}>
                ...
                <p className="text-xl">Op. <span>{Number.isInteger(currentComposition.opusNo)
                    ...
                    : String(currentComposition.opusNo).split('.')[1]
                        ? `${String(currentComposition.opusNo).split('.')[0]}, No. ${String(currentComposition.opusNo).split('.')[1]}`
                        : currentComposition.opusNo}</span></p>
                <p className="italic">for {currentComposition.instrumentation}</p>
                <img className="border border-stone-200 rounded-xl min-h-[60vh] h-1/2 w-1/2 my-5" src="" alt=""/>
            ...
            <table className={`${showDetails ? 'opacity-20 z-0' : 'z-50'} border border-stone-200 text-sm w-11/12 mx-auto mb-12 table-fixed`}>
                <thead>
                    <tr className="font-bold border border-stone-200 bg-stone-700">
                        ...
                        <td className={tdStyle + ' w-[5%]'}>Opus</td>
                        <td className={tdStyle + ' w-[40%]'}>Title</td>
                ...
                <tbody>
                    ...
                    <tr key={composition.composer + composition.opusNo} className="hover:bg-stone-600 hover:cursor-pointer" onClick={() => {
                        ...
                        <td className={tdStyle}>{composition.opusNo}</td>
