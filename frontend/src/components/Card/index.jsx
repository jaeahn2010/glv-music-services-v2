...
export default function Card({ opus, setOpusDetails, allMusicians }) {
    ...
    return (
        <Link to={"/opus/details/" + opus._id} onClick={() => setOpusDetails(opus)}>
            <figure className="flex my-5 p-2 text-stone-700 border-2 border-stone-600 rounded-xl bg-stone-300 shadow-lg hover:scale-105 hover:cursor-pointer hover:duration-500 font-bodoni">
