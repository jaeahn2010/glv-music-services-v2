...
export default function AboutPage({isMenuOpen}) {
    ...
    return (
        <main className={`${isMenuOpen ? 'z-0 opacity-5' : ''} flex flex-col items-center justify-center text-stone-200`}>
            <h1 className="text-xl text-center my-10">About the Greater Las Vegas Music Services</h1>
            <article className='relative w-11/12 mx-auto'>
                <img className='rounded-xl mr-2 my-1 w-1/2 float-left' src={maria9} alt="maria-headshot" />
                ...
                <img className='rounded-xl ml-2 my-1 w-1/2 float-right' src={jae9} alt="jae-headshot"/>
            ...
            <div className='w-11/12 mx-auto my-10 flex justify-center items-center'>
