    ...
    return (
        <main className={`${isMenuOpen ? 'z-0 opacity-5' : ''} flex flex-col items-center justify-center text-stone-200 font-poppins`}>
            ...
            <article className='relative w-11/12 lg:w-1/2 mx-auto lg:text-xl'>
                <img className='rounded-xl mr-2 my-1 w-1/2 lg:w-1/4 float-left' src={maria9} alt="maria-headshot" />
                ...
                <img className='rounded-xl ml-2 my-1 w-1/2 lg:w-1/4 float-right' src={jae9} alt="jae-headshot"/>
